...
public final class Limelight {
  ...
  /**
   * Creates an instance of the Limelight class given the name of the Limelight. For example, if the
   * Limelight is called "limelight-cargo", pass in "cargo".
   *
  ...
  /**
   * Sets whether you want the Limelight to take snapshots or not. When it's taking snapshots, it
   * will do it twice every second.
   *
