...
import common.control.SplinePathSegment;
import common.math.spline.Spline;
import org.ejml.simple.SimpleMatrix;

public final class PathSegmentJsonHandler
    implements JsonSerializer<PathSegment>, JsonDeserializer<PathSegment> {
  @Override
