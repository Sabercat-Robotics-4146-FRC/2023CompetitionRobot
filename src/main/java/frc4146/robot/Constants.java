...
public class Constants {
  ...
  public static class DriveConstants {
    ...
    public static final double DRIVETRAIN_FRONT_RIGHT_STEER_OFFSET = -Math.toRadians(283.179 + 180);
    ...
    public static final double DRIVETRAIN_FRONT_LEFT_STEER_OFFSET = -Math.toRadians(278.78 + 180);
    ...
    public static final double DRIVETRAIN_BACK_LEFT_STEER_OFFSET = -Math.toRadians(329.4 + 180);
    ...
    public static final double DRIVETRAIN_BACK_RIGHT_STEER_OFFSET = -Math.toRadians(153.864 + 180);
