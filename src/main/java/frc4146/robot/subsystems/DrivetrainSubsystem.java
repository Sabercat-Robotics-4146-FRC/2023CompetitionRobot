  ...
  */
  ...
  private final SwerveKinematics swerveKinematics =
      new SwerveKinematics(
          new Vector2(DriveConstants.TRACKWIDTH / 2.0, DriveConstants.WHEELBASE / 2.0), // front left
          new Vector2(DriveConstants.TRACKWIDTH / 2.0, -DriveConstants.WHEELBASE / 2.0), // front right
          new Vector2(-DriveConstants.TRACKWIDTH / 2.0, DriveConstants.WHEELBASE / 2.0), // back left
          new Vector2(-DriveConstants.TRACKWIDTH / 2.0, -DriveConstants.WHEELBASE / 2.0) // back right
          );
  ...
  private final SwerveOdometry swerveOdometry = new SwerveOdometry(swerveKinematics, RigidTransform2.ZERO); // starting at (0, 0) with initial angle 0 degrees
  ...
  private void updateOdometry(double time, double dt) {
    ...
    ChassisVelocity velocity = swerveKinematics.toChassisVelocity(moduleVelocities); // translates individual module velocities into composite velocity for robot
